...
<body id="page-top">
		...
		<div style="margin-right: 150px;" class="collapse navbar-collapse"
			...
			<ul class="navbar-nav text-uppercase ml-auto">
				...
				<li class="nav-item"><a
					...
					class="nav-link js-scroll-trigger" href="dessert.do">Drinks
						Menu </a></li>
				<li class="nav-item"><a
		...
		<div class="container">
			...
			<div class="card">
				<div style="text-align: center;" class="card-header">
					<b style="font-size: 25px;">${foods.dessertName}</b>
				</div>
				<div class="card-body">
				...
				<div class="card-footer">
					...
					<a id="s${foods.dessertId}" onClick="select(this); return false;"
						data-todo='{"foodName":"${foods.dessertName}","price":"${foods.dessertPrice}", "numberTable": 0, "quantity": 1}'
	...
	<script>
		...
		function check() {
			...
			document.getElementById("totalPrice").innerHTML = " Total+Vat7% : "
					+ GGG + " Baht."
