		...
		<div style="    margin-left: 67px;" class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav text-uppercase ml-auto">
				...
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
					...
					class="nav-link js-scroll-trigger" href="addDrink.do">Manage
						Drinks</a></li>
						<li class="nav-item"><a class="nav-link js-scroll-trigger"
					href="addDessert.do">Manage Dessert</a></li>
					<li class="nav-item"><a class="nav-link js-scroll-trigger"
					href="chefList.do">Chef Lists</a></li>
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
					href="serviceman.do">Serviceman Lists</a></li>
			</ul>
		</div>
	...
	<div class="container-fluid">
		...
		<div id="myModal1" role="dialog" class="modal"
			...
			<div style="width: 500px;" class="modal-content">
				...
				<div class="container1">
					<h3>Input Data</h3>
					<form:form method="post" action="uploadDrink.do"
						...
						<br />
								Foods Price : <input
							style="border-radius: 8px; margin-top: 8px;" name="drinkPrice" />
						<br />
					...
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<div class="row">
									<div class="col-md-4">
										<img style="height: 150px;" src="img/drink/${foods.drinkImage}"
											class="img-responsive">
									</div>
									<div class="col-md-8">
										<h6 style="font-size: 35px;">Name : ${foods.drinkName}</h6>
										<p style="font-size: 20px;">Price : ${foods.drinkPrice} Baht.</p>
										...
										<a
											...
											href="deleteDrink.do?id=${foods.drinkId}"
