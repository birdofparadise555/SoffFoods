		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav text-uppercase ml-auto">
				...
				<li class="nav-item"><a
					...
					class="nav-link js-scroll-trigger" href="drinkFrom.do">Manage
						Foods</a></li>
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
					href="managedeserts.html">Manage deserts</a></li>
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
					href="managedrinking.html">Manage Drinking</a></li>
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
					href="managefoodsset.html">Manage Foods set</a></li>
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
	...
	<div class="container-fluid">
		<div class="card-footer">
			<button data-toggle="modal" data-target="#myModal1" id="BtnAdd"
				class="btn btn-primary btn-block btn-lg">Drink</button>
		</div>
