...
<body id="page-top">
	...
	<div class="container">
		...
		<div style="margin-left: 67px;" class="collapse navbar-collapse"
			id="navbarResponsive">
			<ul class="navbar-nav text-uppercase ml-auto">
				...
				<li class="nav-item"><a
					...
					class="nav-link js-scroll-trigger" href="addDessert.do">Manage
						Dessert</a></li>
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
	...
	<div class="container-fluid">
		...
		<div id="myModal1" role="dialog" class="modal"
			...
			<div style="width: 500px;" class="modal-content">
				...
				<div class="container1">
					<h3>Input Data</h3>
					<form:form method="post" action="uploadDessert.do"
						...
						<br />
								Foods Price : <input
							style="border-radius: 8px; margin-top: 8px;" name="dessertPrice" />
						<br />
								...
								<div class="row">
									<div class="col-md-4">
										<img style="height: 150px;"
											src="img/dessert/${foods.dessertImage}"
											class="img-responsive">
									</div>
									<div class="col-md-8">
										<h6 style="font-size: 35px;">Name : ${foods.dessertName}</h6>
										<p style="font-size: 20px;">Price : ${foods.dessertPrice}
											Baht.</p>
											...
											<div style="top: 150px;" class="modal-dialog" role="document">
												<div class="modal-content">
													...
													<div class="modal-body">
														<form:form method="post" action="saveDessert.do"
															commandName="food">
															<form:hidden path="dessertId" value="${foods.dessertId}" />
															<div class="form-group">


																<label for="recipient-name" class="col-form-label">Food
																	Name :</label>
																<form:input value="${foods.dessertName}"
																	path="dessertName" />
																<br />
															</div>
															<div class="form-group">
																<label for="message-text" class="col-form-label">Food
																	Price:</label>
																<form:input value="${foods.dessertPrice}"
																	path="dessertPrice" />
																<br />
															</div>
													</div>
										...
										<a
											...
											href="deleteDessert.do?id=${foods.dessertId}"
