		...
		<div class="container">
			...
			<div class="card">
				<div style="text-align: center;" class="card-header">
					<b style="font-size: 25px;">${foods.drinkName}</b>
				</div>
				<div class="card-body">
				...
				<div class="card-footer">
					...
					<a id="s${foods.drinkId}" onClick="select(this); return false;"
						data-todo='{"foodName":"${foods.drinkName}","price":"${foods.drinkPrice}", "numberTable": 0, "quantity": 1}'
